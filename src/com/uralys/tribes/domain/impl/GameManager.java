...
//		}
	...
	private List<Unit> placeUnit(Unit unit, List<Move> moves, List<Unit> unitsMakingThisReplacing) {
		...
		for(Move newMove : moves){
			...
			if(foundAGathering){
				if(debug)System.out.println("foundAGathering yet => mouvement non appliquŽ");
				currentUnitValue = 0;
			}
	 ...
	 * comme ca la newUnit est toujours liee au gathering1 et appartient ˆ gathering2.units
